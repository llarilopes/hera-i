...
export default async function handler(
  ...
  try {
    // Log para depuração
    console.log('API Visit Time - Recebido:', req.body);
    
    // Encaminhar a requisição para o backend Laravel
    const backendResponse = await fetch(`${BACKEND_URL}/visit/time`, {
      method: 'POST',
      headers: {
